...
public class DataController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    		...
    		{
    			String savePath = "C:\\Users\\vyask\\Java\\SSIP\\WebContent\\birth_images";
    		    ...
    		    String savePath2 = "C:\\Users\\vyask\\Java\\SSIP\\WebContent\\birth_images";
...
//    	        d.setUid(Integer.parseInt(request.getParameter("uid")));
			...
			{
				String savePath = "C:\\Users\\vyask\\Java\\SSIP\\WebContent\\death_images";
    			File fileSaveDir=new File(savePath);
    	        if(!fileSaveDir.exists()){
    	            fileSaveDir.mkdir();
    	        }
    		    ...
    		    String savePath2 = "C:\\Users\\vyask\\Java\\SSIP\\WebContent\\death_images";
    	        File imgSaveDir=new File(savePath2);
    	        if(!imgSaveDir.exists()){
    	            imgSaveDir.mkdir();
